...
class UserFavorites {
  constructor(userFavorites){
    this.favoriteName = userFavorites["attributes"]
  }
}

function setUserVariabes(){
  userApiKey = "6808608d5f587d0e83e51e9bbbf4";
  getUserFavorites(userApiKey);
  displayFavorites();
}

function displayFavorites(){
  document.getElementById("favorites").innerHTML = `${weatherForecastObj.locationName}`;
}
